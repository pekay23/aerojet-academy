...
async function main() {
  ...
  // Create Staff user
  const staffPassword = await bcrypt.hash(process.env.STAFF_PASSWORD || 'Staff@2026', 12)
  ...
  const instructorPassword = await bcrypt.hash(
    process.env.INSTRUCTOR_PASSWORD || 'Instructor@2026',
    12
  )
  ...
  const moduleData = [
    {
      ...
      description:
        'Covers the essential mathematical foundation for all subsequent technical modules. Topics include arithmetic operations, fractions, decimals, percentages, algebra, logarithms, geometry, trigonometry, and co-ordinate geometry. Required by all licence categories.',
      duration: 20,
      price: 1190.0,
    ...
    },
    {
      ...
      description:
        'Provides the scientific underpinning for all engineering modules. Covers the structure of matter and atoms, mechanics (forces, energy, motion), fluid mechanics, thermodynamics, optics, and wave motion/sound. Bridges the gap between mathematics and engineering applications.',
      duration: 20,
      price: 1190.0,
      categoryId: coreCategory.id,
      moduleType: 'CORE' as const,
    ...
    },
    {
      ...
      description:
        'Comprehensive coverage of electrical theory from electron theory and static electricity through to complex AC circuits. Includes DC and AC sources, resistance, capacitance, inductance, transformers, filters, and motor/generator theory. Critical for both mechanical (B1) and avionics (B2) pathways.',
      duration: 24,
      price: 1400.0,
      categoryId: coreCategory.id,
      moduleType: 'CORE' as const,
    ...
    },
    {
      ...
      description:
        'Builds on Module 3 to cover semiconductor devices (diodes, transistors, integrated circuits), printed circuit boards, and servomechanisms (synchros). B2 licence requires deeper knowledge than B1. Not required for Category A. Foundational for understanding modern aircraft electronics.',
      duration: 20,
      price: 1190.0,
      categoryId: coreCategory.id,
      moduleType: 'CORE' as const,
    ...
    },
    {
      ...
      description:
        'Introduces the full range of aircraft materials (ferrous alloys, non-ferrous alloys, composites, non-metallics) and the hardware that holds aircraft together. Covers corrosion causes and prevention, fasteners, pipes and unions, springs, bearings, transmissions, control cables, and electrical connectors.',
      duration: 25,
      price: 1400.0,
      categoryId: coreCategory.id,
      moduleType: 'CORE' as const,
    ...
    },
    {
      ...
      description:
        'Examines the human element in aviation maintenance safety. Covers human performance and limitations, social psychology, team dynamics and communication (CRM), workload, fatigue, stress, situational awareness, and maintenance error. EASA Part-66 examines this module with both MCQ and essay parts.',
      duration: 15,
      price: 1030.0,
      categoryId: coreCategory.id,
      moduleType: 'CORE' as const,
    ...
    },
    {
      ...
      description:
        'The most extensive B1 module \u2014 covers all major systems of turbine-powered aeroplanes in detail. Includes advanced theory of flight, airframe structures (fuselage, wings, empennage), air conditioning & pressurisation, instruments/avionics, electrical power, flight controls, fuel systems, hydraulics, ice protection, landing gear, oxygen, pneumatics, and onboard maintenance systems (ATA chapters 21\u201345).',
      duration: 25,
      price: 1400.0,
    ...
    },
    {
      ...
      description:
        'Specifically scoped for Category B3 \u2014 non-pressurised piston-engine aeroplanes of 2,000 kg MTOM and below. Covers the same general subjects as 11B but with simpler systems appropriate to light aircraft: structures, flight controls, basic electrical systems, fuel systems, and landing gear.',
      duration: 25,
      price: 1400.0,
      categoryId: specialistCategory.id,
      moduleType: 'SPECIALIST' as const,
    ...
    },
    {
      ...
      description:
        'The B2-specific equivalent of Module 11. Provides avionics engineers with the comprehensive knowledge of aircraft systems they need to maintain and troubleshoot avionics, electrical systems, and instruments. Includes flight control surfaces, auto-flight (autopilot, autothrust), communications, navigation, electrical power, fuel systems, fire detection, landing gear, pressurisation, and IMA (Integrated Modular Avionics). Updated June 2024.',
      duration: 25,
      price: 1400.0,
    ...
    },
    {
      ...
      description:
        'Provides B2 avionics engineers with essential propulsion knowledge needed to understand the engine/avionics interface. Covers turbine engine fundamentals, FADEC (Full Authority Digital Engine Control), engine indication systems (EICAS/ECAM), engine health monitoring, and the integration of propulsion systems with the wider aircraft avionics architecture.',
      duration: 15,
      price: 1090.0,
      categoryId: avionicsCategory.id,
      moduleType: 'AVIONICS' as const,
    ...
    },
    {
      ...
      description:
        'Comprehensive coverage of gas turbine engines for turbine-rated licences (A1/A3/B1.1/B1.3). Covers thermodynamic fundamentals, engine performance, intake, compressors, combustion, turbine, exhaust, bearings/seals, lubrication, fuel systems, air systems, starting/ignition, engine indication, power augmentation, turboprop/turboshaft/APU variants, powerplant installation, fire protection, engine monitoring, and storage.',
      duration: 25,
      price: 1400.0,
      categoryId: specialistCategory.id,
      moduleType: 'SPECIALIST' as const,
  ...
  const examComponents = [
    ...
    // M3 — Electrical Fundamentals
    {
      ...
      courseCode: 'M3',
      categoryCode: 'A',
      name: 'Electrical Fundamentals MCQ (Cat A)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    {
      ...
      courseCode: 'M3',
      categoryCode: 'B1',
      name: 'Electrical Fundamentals MCQ (Cat B1)',
      type: 'MCQ' as const,
      questionCount: 52,
      duration: 65,
    },
    {
      ...
      courseCode: 'M3',
      categoryCode: 'B2',
      name: 'Electrical Fundamentals MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 52,
      duration: 65,
    },
    {
      ...
      courseCode: 'M3',
      categoryCode: 'B3',
      name: 'Electrical Fundamentals MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 24,
      duration: 30,
    },
    ...
    // M4 — Electronic Fundamentals (not required for Cat A)
    {
      ...
      courseCode: 'M4',
      categoryCode: 'B1',
      name: 'Electronic Fundamentals MCQ (Cat B1)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    {
      ...
      courseCode: 'M4',
      categoryCode: 'B2',
      name: 'Electronic Fundamentals MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 40,
      duration: 50,
    },
    {
      ...
      courseCode: 'M4',
      categoryCode: 'B3',
      name: 'Electronic Fundamentals MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 8,
      duration: 10,
    },
    ...
    // M5 — Digital Techniques
    {
      ...
      courseCode: 'M5',
      categoryCode: 'A',
      name: 'Digital Techniques MCQ (Cat A)',
      type: 'MCQ' as const,
      questionCount: 16,
      duration: 20,
    },
    {
      ...
      courseCode: 'M5',
      categoryCode: 'B1.1',
      name: 'Digital Techniques MCQ (Cat B1.1)',
      type: 'MCQ' as const,
      questionCount: 40,
      duration: 50,
    },
    {
      ...
      courseCode: 'M5',
      categoryCode: 'B1.2',
      name: 'Digital Techniques MCQ (Cat B1.2)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    {
      ...
      courseCode: 'M5',
      categoryCode: 'B1.3',
      name: 'Digital Techniques MCQ (Cat B1.3)',
      type: 'MCQ' as const,
      questionCount: 40,
      duration: 50,
    },
    {
      ...
      courseCode: 'M5',
      categoryCode: 'B1.4',
      name: 'Digital Techniques MCQ (Cat B1.4)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    {
      ...
      courseCode: 'M5',
      categoryCode: 'B2',
      name: 'Digital Techniques MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 72,
      duration: 90,
    },
    {
      ...
      courseCode: 'M5',
      categoryCode: 'B3',
      name: 'Digital Techniques MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 16,
      duration: 20,
    },
    ...
    // M6 — Materials & Hardware
    {
      ...
      courseCode: 'M6',
      categoryCode: 'A',
      name: 'Materials & Hardware MCQ (Cat A)',
      type: 'MCQ' as const,
      questionCount: 52,
      duration: 65,
    },
    {
      ...
      courseCode: 'M6',
      categoryCode: 'B1',
      name: 'Materials & Hardware MCQ (Cat B1)',
      type: 'MCQ' as const,
      questionCount: 72,
      duration: 90,
    },
    {
      ...
      courseCode: 'M6',
      categoryCode: 'B2',
      name: 'Materials & Hardware MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 60,
      duration: 75,
    },
    {
      ...
      courseCode: 'M6',
      categoryCode: 'B3',
      name: 'Materials & Hardware MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 60,
      duration: 75,
    },
    ...
    // M7 — Maintenance Practices (post June 2024)
    {
      ...
      courseCode: 'M7',
      categoryCode: 'A',
      name: 'Maintenance Practices MCQ (Cat A)',
      type: 'MCQ' as const,
      questionCount: 72,
      duration: 90,
    },
    {
      ...
      courseCode: 'M7',
      categoryCode: 'B1',
      name: 'Maintenance Practices MCQ (Cat B1)',
      type: 'MCQ' as const,
      questionCount: 80,
      duration: 100,
    },
    {
      ...
      courseCode: 'M7',
      categoryCode: 'B2',
      name: 'Maintenance Practices MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 60,
      duration: 75,
    },
    {
      ...
      courseCode: 'M7',
      categoryCode: 'B3',
      name: 'Maintenance Practices MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 60,
      duration: 75,
    },
    {
      ...
      courseCode: 'M7',
      categoryCode: 'A',
      name: 'Maintenance Practices Essay (Cat A)',
      type: 'ESSAY' as const,
      questionCount: 2,
      duration: 40,
    },
    {
      ...
      courseCode: 'M7',
      categoryCode: 'B1',
      name: 'Maintenance Practices Essay (Cat B1)',
      type: 'ESSAY' as const,
      questionCount: 2,
      duration: 40,
    },
    {
      ...
      courseCode: 'M7',
      categoryCode: 'B2',
      name: 'Maintenance Practices Essay (Cat B2)',
      type: 'ESSAY' as const,
      questionCount: 2,
      duration: 40,
    },
    {
      ...
      courseCode: 'M7',
      categoryCode: 'B3',
      name: 'Maintenance Practices Essay (Cat B3)',
      type: 'ESSAY' as const,
      questionCount: 2,
      duration: 40,
    },
    ...
    // M8 — Basic Aerodynamics
    {
      ...
      courseCode: 'M8',
      categoryCode: 'A',
      name: 'Basic Aerodynamics MCQ (Cat A)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    {
      ...
      courseCode: 'M8',
      categoryCode: 'B1',
      name: 'Basic Aerodynamics MCQ (Cat B1)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    {
      ...
      courseCode: 'M8',
      categoryCode: 'B2',
      name: 'Basic Aerodynamics MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    {
      ...
      courseCode: 'M8',
      categoryCode: 'B3',
      name: 'Basic Aerodynamics MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 20,
      duration: 25,
    },
    ...
    },
    {
      ...
      courseCode: 'M9',
      categoryCode: 'A',
      name: 'Human Factors Essay (Cat A)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    {
      ...
      courseCode: 'M9',
      categoryCode: 'B1',
      name: 'Human Factors Essay (Cat B1)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    {
      ...
      courseCode: 'M9',
      categoryCode: 'B2',
      name: 'Human Factors Essay (Cat B2)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    {
      ...
      courseCode: 'M9',
      categoryCode: 'B3',
      name: 'Human Factors Essay (Cat B3)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    ...
    // M10 — Aviation Legislation (post June 2024 — MCQ only)
    {
      ...
      courseCode: 'M10',
      categoryCode: 'A',
      name: 'Aviation Legislation MCQ (Cat A)',
      type: 'MCQ' as const,
      questionCount: 32,
      duration: 40,
    },
    {
      ...
      courseCode: 'M10',
      categoryCode: 'B1',
      name: 'Aviation Legislation MCQ (Cat B1)',
      type: 'MCQ' as const,
      questionCount: 40,
      duration: 50,
    },
    {
      ...
      courseCode: 'M10',
      categoryCode: 'B2',
      name: 'Aviation Legislation MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 40,
      duration: 50,
    },
    {
      ...
      courseCode: 'M10',
      categoryCode: 'B3',
      name: 'Aviation Legislation MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 32,
      duration: 40,
    },
    {
      ...
      courseCode: 'M10',
      categoryCode: 'A',
      name: 'Aviation Legislation Essay (Cat A)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    {
      ...
      courseCode: 'M10',
      categoryCode: 'B1',
      name: 'Aviation Legislation Essay (Cat B1)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    {
      ...
      courseCode: 'M10',
      categoryCode: 'B2',
      name: 'Aviation Legislation Essay (Cat B2)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    {
      ...
      courseCode: 'M10',
      categoryCode: 'B3',
      name: 'Aviation Legislation Essay (Cat B3)',
      type: 'ESSAY' as const,
      questionCount: 1,
      duration: 20,
    },
    ...
    // M11A — Turbine Aeroplane Aerodynamics, Structures & Systems
    {
      ...
      courseCode: 'M11A',
      categoryCode: 'A1',
      name: 'Turbine Aeroplane Systems MCQ (Cat A1)',
      type: 'MCQ' as const,
      questionCount: 108,
      duration: 135,
    },
    {
      ...
      courseCode: 'M11A',
      categoryCode: 'B1.1',
      name: 'Turbine Aeroplane Systems MCQ (Cat B1.1)',
      type: 'MCQ' as const,
      questionCount: 140,
      duration: 175,
    },
    ...
    // M11B — Piston Aeroplane Aerodynamics, Structures & Systems
    {
      ...
      courseCode: 'M11B',
      categoryCode: 'A2',
      name: 'Piston Aeroplane Systems MCQ (Cat A2)',
      type: 'MCQ' as const,
      questionCount: 72,
      duration: 90,
    },
    {
      ...
      courseCode: 'M11B',
      categoryCode: 'B1.2',
      name: 'Piston Aeroplane Systems MCQ (Cat B1.2)',
      type: 'MCQ' as const,
      questionCount: 100,
      duration: 125,
    },
    ...
    // M11C — Piston Aeroplane (B3)
    {
      ...
      courseCode: 'M11C',
      categoryCode: 'B3',
      name: 'Piston Aeroplane Systems MCQ (Cat B3)',
      type: 'MCQ' as const,
      questionCount: 60,
      duration: 75,
    },
    ...
    // M12 — Helicopter Aerodynamics, Structures & Systems
    {
      ...
      courseCode: 'M12',
      categoryCode: 'A3',
      name: 'Helicopter Systems MCQ (Cat A3)',
      type: 'MCQ' as const,
      questionCount: 100,
      duration: 125,
    },
    {
      ...
      courseCode: 'M12',
      categoryCode: 'A4',
      name: 'Helicopter Systems MCQ (Cat A4)',
      type: 'MCQ' as const,
      questionCount: 100,
      duration: 125,
    },
    {
      ...
      courseCode: 'M12',
      categoryCode: 'B1.3',
      name: 'Helicopter Systems MCQ (Cat B1.3)',
      type: 'MCQ' as const,
      questionCount: 128,
      duration: 160,
    },
    {
      ...
      courseCode: 'M12',
      categoryCode: 'B1.4',
      name: 'Helicopter Systems MCQ (Cat B1.4)',
      type: 'MCQ' as const,
      questionCount: 128,
      duration: 160,
    },
    ...
    // M13 — Aircraft Aerodynamics, Structures & Systems (B2 only)
    {
      ...
      courseCode: 'M13',
      categoryCode: 'B2',
      name: 'Aircraft Systems MCQ (Cat B2)',
      type: 'MCQ' as const,
      questionCount: 180,
      duration: 225,
    },
    ...
    // M15 — Gas Turbine Engine
    {
      ...
      courseCode: 'M15',
      categoryCode: 'A1',
      name: 'Gas Turbine Engine MCQ (Cat A1)',
      type: 'MCQ' as const,
      questionCount: 60,
      duration: 75,
    },
    {
      ...
      courseCode: 'M15',
      categoryCode: 'A3',
      name: 'Gas Turbine Engine MCQ (Cat A3)',
      type: 'MCQ' as const,
      questionCount: 60,
      duration: 75,
    },
    {
      ...
      courseCode: 'M15',
      categoryCode: 'B1.1',
      name: 'Gas Turbine Engine MCQ (Cat B1.1)',
      type: 'MCQ' as const,
      questionCount: 92,
      duration: 115,
    },
    {
      ...
      courseCode: 'M15',
      categoryCode: 'B1.3',
      name: 'Gas Turbine Engine MCQ (Cat B1.3)',
      type: 'MCQ' as const,
      questionCount: 92,
      duration: 115,
    },
    ...
    },
    {
      ...
      courseCode: 'M16',
      categoryCode: 'B1.2',
      name: 'Piston Engine MCQ (Cat B1.2)',
      type: 'MCQ' as const,
      questionCount: 72,
      duration: 90,
    },
    {
      ...
      courseCode: 'M16',
      categoryCode: 'B1.4',
      name: 'Piston Engine MCQ (Cat B1.4)',
      type: 'MCQ' as const,
      questionCount: 72,
      duration: 90,
    },
          ...
          semesters: [
            {
              ...
              endDate: new Date(
                new Date(y.sem1).getFullYear(),
                new Date(y.sem1).getMonth() + 5,
                0
              ).toISOString(),
            },
            {
              ...
              endDate: new Date(
                new Date(y.sem2).getFullYear(),
                new Date(y.sem2).getMonth() + 5,
                0
              ).toISOString(),
            },
          ],
        ...
        semesters: [
          {
            ...
            endDate: new Date('2027-01-31').toISOString(),
          },
          {
            name: 'Semester 2',
            startDate: new Date('2027-02-01').toISOString(),
            endDate: new Date('2027-06-30').toISOString(),
          },
        ],
        isActive: true,
      },
  ...
  // Admin-editable settings: bank details and pricing — use update: {} to preserve
  // values that were customized via the admin panel after initial seed.
  const preserveOnReseed = new Set([
    'bank_name',
    'bank_account_name',
    'bank_account_number',
    'bank_swift',
  ...
  for (const setting of settings) {
    await prisma.systemSetting.upsert({
      ...
      update: preserveOnReseed.has(setting.key) ? {} : { value: setting.value },
      create: setting,
    })
  }
  ...
  // ============================================================================
  const studentPassword = await bcrypt.hash(process.env.STUDENT_PASSWORD || 'Student@2026', 12)
  ...
  const applicantPassword = await bcrypt.hash(
    process.env.APPLICANT_PASSWORD || 'Applicant@2026',
    12
  )
