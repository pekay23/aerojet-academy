...
const PORTALS: PortalConfig[] = [
  { role: 'Staff', email: 'staff@aerojet-academy.com', password: 'Staff@2026', dashboardUrl: '/staff/dashboard', expectsPath: '/staff' },
  { role: 'Student', email: 'student@aerojet-academy.com', password: 'Student@2026', dashboardUrl: '/student', expectsPath: '/student' },
  { role: 'Instructor', email: 'instructor@aerojet-academy.com', password: 'Instructor@2026', dashboardUrl: '/instructor/dashboard', expectsPath: '/instructor' },
  { role: 'Applicant', email: 'applicant@example.com', password: 'Applicant@2026', dashboardUrl: '/applicant', expectsPath: '/applicant' },
  { role: 'Examiner', email: 'examiner@aerojet-academy.com', password: 'Examiner@2026', dashboardUrl: '/examiner', expectsPath: '/examiner' },
]
