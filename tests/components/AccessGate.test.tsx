...
describe('AccessGate', () => {
  ...
  it('renders lock message when hasAccess is false', () => {
    render(<AccessGate hasAccess={false} feature="WALLET"><div>Protected Content</div></AccessGate>)
  ...
  it('renders payment link when no access', () => {
    render(<AccessGate hasAccess={false} feature="WALLET"><div>Content</div></AccessGate>)
