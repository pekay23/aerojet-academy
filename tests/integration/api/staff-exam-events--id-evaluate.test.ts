...
import { GET } from '@/app/api/staff/exam-events/[id]/evaluate/route.ts'
import { requireStaff } from '@/lib/auth/helpers'

describe('/staff/exam-events/:id/evaluate', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('returns 401 when unauthenticated', async () => {
    ...
    const req = new NextRequest('http://localhost/staff/exam-events/1/evaluate')
