...
import { GET } from '@/app/api/staff/newsroom/[id]/route.ts'
import { PATCH } from '@/app/api/staff/newsroom/[id]/route.ts'
import { DELETE } from '@/app/api/staff/newsroom/[id]/route.ts'
