...
import { POST } from '@/app/api/staff/admissions/interviews/schedules/[id]/slots/route.ts'
...
describe('POST /api/staff/admissions/interviews/schedules/[id]/slots', () => {
  ...
  describe('POST', () => {
    it('returns 401 when unauthenticated', async () => {
      ...
      const req = new NextRequest('http://localhost/api/staff/admissions/interviews/schedules/schedule-1/slots', {
        method: 'POST',
