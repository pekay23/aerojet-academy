...
import { GET } from '@/app/api/instructor/classes/[id]/route.ts'
...
describe('/instructor/classes/:id', () => {
  ...
  it('returns 200 with data', async () => {
    prismaMock.class.findUnique.mockResolvedValue({ id: '1', status: 'ACTIVE', course: {"id":"1"}, instructorId: '1' } as any)
