...
vi.mock('@/lib/internal-exam/engine', () => ({ isInternalExamSystemEnabled: vi.fn().mockResolvedValue(true) }))

import { GET } from '@/app/api/staff/exams/internal/banks/[bankId]/questions/route.ts'
