...
import { GET } from '@/app/api/staff/admissions/intake-cycles/[id]/route.ts'
import { PUT } from '@/app/api/staff/admissions/intake-cycles/[id]/route.ts'
import { DELETE } from '@/app/api/staff/admissions/intake-cycles/[id]/route.ts'
