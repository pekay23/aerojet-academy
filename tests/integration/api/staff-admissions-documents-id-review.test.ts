...
import { POST } from '@/app/api/staff/admissions/documents/[id]/review/route.ts'
...
describe('POST /api/staff/admissions/documents/[id]/review', () => {
  ...
  describe('POST', () => {
    ...
    it('returns 404 when document not found', async () => {
      ...
      const req = new NextRequest('http://localhost/api/staff/admissions/documents/nonexistent/review', {
        method: 'POST',
        headers: { Authorization: 'Bearer test-secret' },
        body: JSON.stringify({ status: 'APPROVED' }),
      })
