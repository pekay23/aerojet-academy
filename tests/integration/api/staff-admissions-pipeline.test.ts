...
vi.mock('@/lib/admissions/constants', () => ({
  STAGE_ORDER: ['SUBMITTED', 'MEDICAL_SUBMITTED', 'MEDICAL_CLEARED', 'SHORTLISTED', 'ENROLLED', 'REJECTED', 'WITHDRAWN'],
  STAGE_INFO: {},
}))

import { GET } from '@/app/api/staff/admissions/pipeline/route.ts'
...
describe('GET /api/staff/admissions/pipeline', () => {
  ...
  describe('GET', () => {
    it('returns paginated list', async () => {
      const req = new NextRequest('http://localhost/api/staff/admissions/pipeline?page=1&limit=20', {
