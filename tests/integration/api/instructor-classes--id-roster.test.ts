...
import { GET } from '@/app/api/instructor/classes/[id]/roster/route.ts'
...
describe('/instructor/classes/:id/roster', () => {
  ...
  it('returns 200 with data when resource exists', async () => {
    ...
    prismaMock.enrollment.findMany.mockResolvedValue([{ id: '1', course: {"id":"1"}, student: {"id":"1"}, user: { profile: { firstName: 'John', lastName: 'Doe' }, studentProfile: { studentId: 'STU-001' } } }] as any)
