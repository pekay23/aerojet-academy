...
import { GET } from '@/app/api/staff/exam-events/upcoming/route.ts'
import { requireStaff } from '@/lib/auth/helpers'

describe('/staff/exam-events/upcoming', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('returns 401 when unauthenticated', async () => {
    ...
    const req = new NextRequest('http://localhost/staff/exam-events/upcoming')
