...
vi.mock('@/lib/pools/withdraw', () => ({ withdrawFromPool: vi.fn().mockResolvedValue({ success: true, amountReleased: 100 }) }))

import { describe, it, expect, vi, beforeEach } from 'vitest'
import { prismaMock } from '@/tests/setup'
import { NextRequest } from 'next/server'
import { POST } from '@/app/api/applicant/exam-only/withdraw-pool/route.ts'
