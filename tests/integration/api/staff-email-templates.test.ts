...
import { GET } from '@/app/api/staff/email-templates/route.ts'
import { POST } from '@/app/api/staff/email-templates/route.ts'
import { DELETE } from '@/app/api/staff/email-templates/route.ts'
