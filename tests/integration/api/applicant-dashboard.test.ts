...
import { GET } from '@/app/api/applicant/dashboard/route.ts'
...
describe('/applicant/dashboard', () => {
  beforeEach(() => {
    ...
    prismaMock.user.findUnique.mockResolvedValue({ id: 'user-1', email: 'test@test.com', role: 'APPLICANT', profile: { id: 'profile-1' }, enrollments: [] } as any)
    prismaMock.course.findMany.mockResolvedValue([{ id: '1', code: 'ABC', name: 'Test Course', price: 100 }] as any)
  })
