...
import { GET } from '@/app/api/staff/admissions/document-types/[id]/route.ts'
import { PUT } from '@/app/api/staff/admissions/document-types/[id]/route.ts'
import { DELETE } from '@/app/api/staff/admissions/document-types/[id]/route.ts'
...
describe('GET/PUT/DELETE /api/staff/admissions/document-types/[id]', () => {
  ...
  describe('GET', () => {
    it('returns document type when found', async () => {
      ...
      const req = new NextRequest('http://localhost/api/staff/admissions/document-types/doc-type-1', {
    ...
    it('returns 404 when document type not found', async () => {
      ...
      const req = new NextRequest('http://localhost/api/staff/admissions/document-types/nonexistent', {
        headers: { Authorization: 'Bearer test-secret' },
      })
