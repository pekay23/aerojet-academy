...
import { POST } from '@/app/api/applicant/courses/[id]/enroll/route.ts'
...
describe('/applicant/courses/:id/enroll', () => {
  beforeEach(() => {
    ...
    prismaMock.course.findUnique.mockResolvedValue({ id: '1', code: 'ABC', name: 'Test Course', price: 100, currency: 'EUR' } as any)
