  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-lg overflow-hidden rounded-4xl border-none p-0">
        <div className={cn(
          'p-8 text-white',
          mode === 'edit' ? 'bg-slate-900' : 'bg-aerojet-blue'
        )}>
        ...
        <div className="space-y-8 p-8">
          <div className="grid gap-6">
            <div className="space-y-3">
              <Label
                htmlFor="score"
                className="text-xs font-black tracking-widest text-slate-400 dark:text-slate-300 uppercase"
              >
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                placeholder={mode === 'edit' ? 'Update your feedback for the student...' : 'Provide constructive feedback for the student...'}
          ...
          <DialogFooter className="flex-col gap-3 sm:flex-col">
            ...
            >
              {isSubmitting ? (
                ...
                mode === 'edit' ? 'Save Changes' : 'Confirm & Submit Grade'
              )}
            </Button>
            <Button
              variant="ghost"
              onClick={() => handleOpenChange(false)}
              className="h-12 w-full rounded-2xl font-bold text-slate-400 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white"
            >
