...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-slate-100 tracking-tight">Class Roster</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Students in this class.</p>
      </div>
