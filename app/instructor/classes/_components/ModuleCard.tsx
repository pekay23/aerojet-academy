      ...
      <div className="flex flex-1 flex-col p-6 sm:p-8">
        ...
        <div className="mt-auto flex gap-2">
          <Link
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#4c9ded] py-3 text-[10px] font-black tracking-widest text-white uppercase transition-all hover:bg-[#002a5c]"
          >
