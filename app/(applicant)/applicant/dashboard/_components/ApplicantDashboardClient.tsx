  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in duration-700">
      <div className="bg-linear-to-r from-blue-900 to-blue-800 p-8 rounded-2xl text-white mb-8 shadow-xl">
        ...
        <p className="text-blue-100 opacity-90">Your application has been approved. Please complete your seat confirmation deposit.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="border-2 border-blue-500/20 bg-blue-50/50 dark:bg-blue-950/20 relative">
          ...
          <CardContent>
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 h-12 text-white font-bold" onClick={() => router.push('/applicant/finance')}>
