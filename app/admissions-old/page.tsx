    ...
    <main className="min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="grow">
        <PageHero 
          ...
          backgroundImage="/admissions-hub.jpg"
        />
        ...
        <div className="container mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {/* Card 1: Requirements */}
            <Link href="/admissions/entry-requirements" className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-aerojet-sky transition-all">
              <div className="w-14 h-14 bg-blue-50 text-aerojet-blue rounded-2xl flex items-center justify-center mb-6 group-hover:bg-aerojet-blue group-hover:text-white transition-colors">
                <CheckCircle2 className="w-8 h-8" />
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-aerojet-sky transition-colors">Entry Requirements</h3>
              ...
              <span className="text-xs font-black uppercase tracking-widest text-aerojet-sky flex items-center gap-2">Check Criteria <ArrowRight className="w-4 h-4" /></span>
            </Link>

            {/* Card 2: Process */}
            <Link href="/admissions/how-to-apply" className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-aerojet-sky transition-all">
            ...
            {/* Card 3: Fees */}
            <Link href="/admissions/fees" className="group bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-aerojet-sky transition-all">
          ...
          <div className="bg-aerojet-blue rounded-[3rem] p-12 text-center text-white relative overflow-hidden">
             <div className="relative z-10">
                ...
                <Link href="/register" className="inline-block bg-white text-aerojet-blue px-10 py-4 rounded-xl font-black uppercase tracking-widest text-xs hover:bg-aerojet-sky hover:text-white transition-all">
