...
import JoinPoolForm from './_components/JoinPoolForm'

export const metadata: Metadata = { title: 'Join Pool | Applicant Portal' }
      ...
      <div className="space-y-6 rounded-2xl border border-slate-100 bg-white p-6 sm:p-8 dark:border-slate-800 dark:bg-slate-900">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Confirm your spot in this exam booking. Funds will be reserved from your wallet.
          </p>
        </div>
        ...
        {isFull && (
          <div className="rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-700 dark:border-red-900/40 dark:bg-red-950/20 dark:text-red-400">
            This booking is currently full. Please join the waitlist instead.
          </div>
        )}
