...
export default async function InterviewPage() {
  ...
  if (!session?.user) return await redirectToLogin()
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 max-w-4xl space-y-8 duration-700">
      <div>
        ...
        <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
          Congratulations on being shortlisted! Please select an available interview slot that works
          for you. The interview will be conducted by our admissions panel to assess your readiness
          for the programme.
        </p>
      </div>
