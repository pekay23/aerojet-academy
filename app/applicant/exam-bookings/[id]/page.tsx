...
export default function Page() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-black text-aerojet-blue dark:text-white tracking-tight">Pool Details</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Examination pool information.</p>
      </div>
