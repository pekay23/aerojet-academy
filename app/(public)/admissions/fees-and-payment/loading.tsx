export default function Loading() {
  return (
    <div className="mx-auto max-w-4xl space-y-8 px-4 py-12 animate-pulse" role="status" aria-label="Loading fees information">
      ...
      <div className="space-y-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="h-24 rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-700 dark:bg-slate-800">
