        ...
        <div className="mx-auto max-w-7xl space-y-20">
          ...
          <SectionReveal>
            <section className="text-center">
              ...
              <div className="mx-auto mt-8 w-full max-w-7xl">
                <p className="mb-4 text-xl leading-relaxed text-slate-600">
                  An{' '}
                  <strong className="text-aerojet-blue">Aircraft Maintenance Licence (AML)</strong>{' '}
                  issued in accordance with EASA Part-66 is the primary qualification required for
                  individuals to certify maintenance work on aircraft. It is the international
                  benchmark for quality and safety, demonstrating that a technician has met the high
                  standards of knowledge and experience required by the European Union Aviation
                  Safety Agency.
                </p>
              ...
              {benefits.map((benefit) => (
                <div key={benefit.title} className="p-6">
                  <div className="mb-5 inline-flex h-20 w-20 items-center justify-center rounded-full bg-slate-100">
                    <benefit.icon className="text-public-secondary h-10 w-10" />
                  </div>
                  {/* FIX: Increased text sizes for benefits */}
                  <h3 className="text-public-primary mb-2 text-xl font-bold">{benefit.title}</h3>
          ...
          <SectionReveal>
            <section className="grid gap-12 lg:grid-cols-2">
              ...
              <div className="space-y-12">
                <div>
                  ...
                  <p className="mb-4 text-lg text-slate-600">
                    Careers in aviation expand beyond many industries, but Aircraft Engineering
                    plays a crucial role in ensuring the safety and efficiency of aircraft travel.
                  </p>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <span className="bg-public-secondary mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-xs font-bold text-white">
                        ✓
                      </span>
                      <p className="text-base text-slate-600">
                        Depending on your location, experience, and type ratings,{' '}
                        <strong>Licensed Aircraft Engineers</strong> can earn from £12,000 at entry
                        level to £50,000 or more annually. With flexible shift schedules, you can
                        enjoy a good quality of life and job satisfaction.
                      </p>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="bg-public-secondary mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-xs font-bold text-white">
                      ...
                      <p className="text-base text-slate-600">
                        The demand for Licensed Aircraft Engineers remains high due to ongoing
                        growth in the aviation industry. Opportunities to work for major airlines
                        and MROs are widely available.
                      </p>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="bg-public-secondary mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-xs font-bold text-white">
                      ...
                      <p className="text-base text-slate-600">
                        The role is vital in ensuring the safety and reliability of air travel, as
                        planes cannot fly without their expertise and professional diligence.
                      </p>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-4 text-base leading-relaxed text-slate-600">
                    <p>
                      What type of Engineer you want to be will determine what qualification you
                      require. At Aerojet we train engineers and technicians to be certified to{' '}
                      <strong>EASA Certification standards</strong>, the most widely accepted
                      qualification for Aircraft maintenance personnel globally.
                    </p>
                    <p>
                      The European Aviation Safety Agency (EASA) regulates aviation activity within
                      Europe and delegates authority to its member National Aviation Authorities.
                    </p>
                    <p>
                      To ensure safety, engineering personnel are licensed in the same way as pilots
                      and air traffic controllers. If suitably licensed, an engineer can certify the
                      work carried out on an aircraft and return it to service.
                    </p>
                    <p>
                      <strong>Category A Licence:</strong> A Ramp or Line Maintenance Certifying
                      Mechanic is qualified to work on operational aircraft performing relatively
                      minor maintenance tasks and replacement of parts. Aerojet Academy only
                      provides A Category training on an on-demand basis.
                    </p>
                    <p className="text-public-primary font-bold">
                      At the Academy, our primary focus is training for the higher-level Category B
                      Licence.
                    </p>
                  </div>
                </div>
              ...
              <div className="h-fit rounded-3xl border border-slate-200 bg-slate-50 p-8 sm:p-10">
                <h3 className="text-public-primary mb-6 border-b border-slate-200 pb-4 text-2xl font-black tracking-tight uppercase">
                  Understanding Category B Licencing
                </h3>

                <div className="mb-8 space-y-6">
                  <div>
                    <h4 className="text-aerojet-blue mb-2 text-lg font-bold">
                      Category B1 (Mechanical)
                    </h4>
                    <p className="text-sm leading-relaxed text-slate-600">
                      The Aircraft Maintenance Licence (AML) B1 Category allows the holder to issue
                      certifications of release to service following maintenance, including aircraft
                      structure, power plants, and mechanical and electrical systems. Authorisation
                      to replace avionic line replaceable units (LRUs) requiring simple tests is
                      also permitted. The Licence holder is qualified to work on aircraft that
                      require more complex maintenance tasks or major overhauls.
                    </p>
                  </div>
                  <div>
                    <h4 className="text-aerojet-blue mb-2 text-lg font-bold">
                    ...
                    <p className="text-sm leading-relaxed text-slate-600">
                      The Category B2 allows the holder to issue certificates of release to service
                      following maintenance on avionic and electrical systems. A B2 Avionics
                      Engineer specialises in scheduled maintenance, restoration, and modification
                      of communication, navigation, radar equipment, guidance and control systems
                      (including auto-pilot/auto-land), and cabin entertainment.
                    </p>
                  </div>
                </div>

                <h3 className="text-public-primary mb-6 border-b border-slate-200 pb-4 text-lg font-black tracking-tight uppercase">
                  Licence Categories
                </h3>
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={item.cat}
                      className="flex flex-col rounded-lg border border-slate-100 bg-white p-4 shadow-sm"
                    >
                      <span className="text-aerojet-sky font-bold">{item.cat}</span>
