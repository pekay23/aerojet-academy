...
export const metadata: Metadata = {
  title: 'Privacy & Data Protection Notice | Aerojet Academy',
  description:
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <article className="rounded-2xl border border-slate-100 bg-white p-6 shadow-xl sm:rounded-3xl sm:p-14">
          <div className="mb-10 border-b border-slate-100 pb-6">
            <span className="mb-4 inline-block rounded-full bg-blue-50 px-3 py-1 text-xs font-black text-aerojet-sky uppercase">
              Legal Policy
            </span>
            <h1 className="text-3xl leading-tight font-black text-balance text-aerojet-blue uppercase sm:text-4xl dark:text-white">
              Privacy & Data Protection Notice
            </h1>
            <p className="mt-3 text-sm text-slate-400 italic">Last updated: May 2026</p>
          </div>

          <div className="prose prose-slate max-w-none prose-headings:text-aerojet-blue prose-headings:font-black prose-headings:uppercase prose-p:text-pretty prose-p:text-slate-600 prose-p:leading-relaxed prose-a:font-bold prose-a:text-aerojet-sky prose-a:no-underline hover:prose-a:underline">
            <p className="text-lg">
            ...
            <p>We collect and process personal data only for specific academy purposes, including to:</p>
            <ul>
              {purposes.map((item) => (
                <li key={item}>{item}</li>
              ))}
            ...
            <p>
              ...
              regulatory obligation, legitimate academy operation, consent-based activity, or another
              lawful justification under Act 843. We limit collection to data that is relevant and
            ...
            <p>
              ...
              use reasonable contractual, technical, and organisational safeguards to protect the data
              and to keep processing consistent with Act 843.
            </p>
            ...
            <p>
              ...
              records are deleted, anonymised, or restricted where retention is no longer authorised.
            </p>
            ...
            <p>
              If we have reasonable grounds to believe personal data has been accessed or acquired by
              an unauthorised person, we will investigate, restore system integrity, and notify the
              Data Protection Commission and affected data subjects as soon as reasonably practicable
              where required by Act 843.
            </p>
            ...
            <p>
              We use essential cookies for login, security, and portal functionality. We may also use
              privacy-respecting analytics to understand page performance and improve the website.
              You can control non-essential cookies through your browser settings where available.
            </p>
            ...
            <p>
              ...
              provide personal data for a lawful academy process, we require involvement from a parent
              or guardian and limit processing to the relevant purpose.
            </p>
            ...
            <div className="not-prose mt-10 rounded-xl border border-slate-100 bg-slate-50 p-6">
              <h3 className="mb-3 text-lg font-black text-aerojet-blue uppercase">Contact Us</h3>
              ...
              <p className="text-sm">
                Email:{' '}
                <a href="mailto:info@aerojet-academy.com" className="font-bold text-aerojet-sky">
