  ...
  return (
    <SectionReveal>
      <section className="bg-public-dark px-6 py-24">
        <div className="bg-public-secondary relative mx-auto flex max-w-5xl flex-col items-center justify-between gap-10 overflow-hidden rounded-[2rem] p-8 text-white shadow-2xl sm:rounded-[3rem] md:p-16 lg:flex-row">
