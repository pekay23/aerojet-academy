  ...
  return (
    <SectionReveal>
      <section className="bg-public-dark px-6 py-24">
        <div className="bg-public-secondary relative mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-10 overflow-hidden rounded-4xl p-8 text-white shadow-2xl sm:rounded-[3rem] md:p-16 lg:flex-row">
