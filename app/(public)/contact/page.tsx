      ...
      <div className="max-w-5xl mx-auto px-6 py-16 -mt-20 relative z-20">
        <SectionReveal>
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden grid lg:grid-cols-5 border border-slate-100">
            {/* Info Side */}
            <div className="lg:col-span-2 bg-[#002a5c] p-8 sm:p-10 text-white">
              ...
              <div className="space-y-7">
                {[
                  ...
                  <div key={item.label} className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-[#4c9ded] text-xs uppercase tracking-widest mb-1">{item.label}</h3>
            ...
            <div className="lg:col-span-3 p-8 sm:p-10">
              <h2 className="text-2xl font-black text-[#002a5c] uppercase tracking-tight mb-2">Send us a Message</h2>
