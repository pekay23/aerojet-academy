...
export default function AdvancementEnrollmentsError({
  error,
  reset,
}: {
  ...
  return (
    ...
    >
      ...
      <h2 className="mt-4 text-lg font-black text-slate-900 dark:text-white">
        Unable to load advancement enrollments
      </h2>
      <p className="mt-2 max-w-sm text-sm text-slate-500 dark:text-slate-400">
        The advancement enrollment data failed to load. Try again or go back.
      </p>
