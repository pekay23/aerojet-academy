  ...
  return (
    <div className="group relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-6 shadow-sm transition-all hover:shadow-xl dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="relative flex items-start justify-between">
        ...
        {growth !== undefined && (
          <div
            className={`flex items-center gap-1 rounded-full px-2 py-0.5 text-[11px] font-black uppercase ${
              isPositive
      ...
      <div className="mt-4">
        <p className="text-[11px] font-black tracking-widest text-slate-400 uppercase">{title}</p>
