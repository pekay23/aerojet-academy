...
export const metadata: Metadata = {
  title: 'Aptitude Tests | Aerojet Academy',
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Link href="/staff/admissions/aptitude" className="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-aerojet-blue/50 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center gap-3">
        ...
        <Link href="/staff/admissions/aptitude/results" className="group rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-aerojet-blue/50 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center gap-3">
