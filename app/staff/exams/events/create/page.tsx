  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-[#002a5c] dark:text-white">Create Exam Event</h1>
          <p className="text-slate-500 dark:text-slate-400">Schedule a new examination session.</p>
        </div>
        <Link
          href="/staff/exams/events"
          className="text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-[#002a5c]"
        >
          Cancel
        </Link>
      </div>
