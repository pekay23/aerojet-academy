  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="text-xs font-bold tracking-wider text-slate-400 uppercase">Entries</div>
          <div className="mt-1 text-2xl font-black text-slate-800 dark:text-white">
            {data.entries.length}
          </div>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-1 text-2xl font-black text-slate-800 dark:text-white">
            {a.ataChaptersCovered}
          </div>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center gap-1.5 text-xs font-bold tracking-wider text-green-500 uppercase">
      ...
      <LogbookPreview mode="student" logbook={data} />
