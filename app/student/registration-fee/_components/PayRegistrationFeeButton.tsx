  ...
  return (
    <div className="space-y-3">
      <button
        onClick={handlePay}
        disabled={loading}
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#002a5c] px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-[#001d42] disabled:cursor-not-allowed disabled:opacity-50"
      >
        {loading ? (
          <>
