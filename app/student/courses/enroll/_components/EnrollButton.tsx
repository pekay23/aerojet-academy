...
export default function EnrollButton({
  ...
  return (
    ...
    >
      <button
        disabled={loading}
        className="group/enroll relative flex h-14 w-full items-center justify-center overflow-hidden rounded-2xl bg-[#002a5c] px-8 text-xs font-black tracking-widest text-white uppercase transition-all hover:shadow-[0_0_20px_rgba(0,42,92,0.3)] active:scale-95 disabled:cursor-not-allowed disabled:opacity-70"
      >
