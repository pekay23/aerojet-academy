      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
        ...
        <div className="flex-1 space-y-6">
          <div className="rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-sm">
            <div className="mb-6">
              ...
              <h1 className="mt-3 text-3xl font-black leading-tight tracking-tight text-slate-900 dark:text-slate-100">
                {course.name}
              </h1>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-50 dark:bg-slate-800/50 text-slate-400">
          ...
          <div className="rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-sm">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-slate-100 dark:border-slate-800 p-5 transition-all hover:border-blue-100 hover:bg-blue-50/20">
                ...
                <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">Detailed course curriculum.</p>
                {course.syllabusUrl ? (
                  <a
                  ...
                  <span className="mt-4 inline-block text-[10px] italic text-slate-400">
                    Not available
                  </span>
                )}
              </div>

              <div className="rounded-xl border border-slate-100 dark:border-slate-800 p-5 transition-all hover:border-indigo-100 hover:bg-indigo-50/20">
                ...
                <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">Learning guides and assets.</p>
                {course.materialsUrl ? (
                  <a
        ...
        <div className="w-full space-y-6 lg:w-80">
          <div className="rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm">
            <h3 className="mb-4 text-lg font-black text-slate-900 dark:text-slate-100">Your Progress</h3>
            <div className="space-y-4">
              ...
              <div className="space-y-3 border-t border-slate-50 pt-4">
                <Link
                  ...
                  className="flex items-center justify-between text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-blue-600"
                >
          ...
          <div className="rounded-2xl bg-slate-900 p-6 text-white shadow-xl shadow-slate-200">
            <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-white dark:bg-slate-900/10 text-white">
            ...
            <Link
              ...
              className="block w-full rounded-xl bg-white dark:bg-slate-900 py-3 text-center text-sm font-black text-slate-900 dark:text-slate-100 transition-transform hover:bg-slate-50 active:scale-95"
            >
              Contact Support
            </Link>
          </div>
