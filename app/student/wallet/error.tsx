"use client";
export default function StudentWalletError({ _error, reset }: { _error: Error; reset: () => void }) {
  return (
    <div className="flex items-center justify-center min-h-[60vh]" role="alert">
      <div className="text-center max-w-md">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">An unexpected error occurred while loading your wallet. Please try again or contact support if the problem persists.</p>
