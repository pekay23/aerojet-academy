...
export default async function GradesPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-black tracking-tight text-slate-900 dark:text-slate-100 sm:text-3xl">My Grades</h1>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-50">
                {grades.map((grade) => (
                  <tr key={grade.id} className="transition-colors hover:bg-slate-50 dark:bg-slate-800/50">
                    <td className="px-6 py-4">
                      <div className="font-bold text-slate-900 dark:text-slate-100">{grade.assessmentName}</div>
                      <div className="text-xs text-slate-500 dark:text-slate-400">{grade.assessmentType}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="font-bold text-slate-900 dark:text-slate-100">{grade.enrollment.course.name}</div>
                      <div className="text-xs text-slate-500 dark:text-slate-400">{grade.enrollment.course.code}</div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-right font-medium text-slate-500 dark:text-slate-400">
