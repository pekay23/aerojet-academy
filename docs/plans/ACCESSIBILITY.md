...
> **Deprecated duplicate.** The canonical file is [`ACCESSIBILITY.md`](../ACCESSIBILITY.md) at the repo root.
> This copy is retained only because it was listed in the recovery manifest
> (`docs/guides/session-inventory-and-recovery-reference.md`). Do not edit this file;
> edit the root `ACCESSIBILITY.md` instead.
...
_End of Accessibility Documentation_
