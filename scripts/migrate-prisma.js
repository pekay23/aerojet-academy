...
const dirs = ['app', 'lib', 'scripts', 'tests'];
...
for (const dir of dirs) {
  ...
  for (const entry of entries) {
    ...
    if (content.includes("import prisma from '@/lib/prisma/client'")) {
      content = content
        .replace(/import prisma from '@\/lib\/prisma\/client'/g, "import { prismaUnfiltered } from '@/lib/prisma/client'")
